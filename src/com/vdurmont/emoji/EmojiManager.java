...
public class EmojiManager {
  ...
  static {
    try {
      ...
      List<Emoji> emojis = EmojiLoader.loadEmojis(new File("resources/emojis.json"));
      ALL_EMOJIS = emojis;
      ...
      throw new RuntimeException(e);
          ...
          Logger.getLogger(EmojiManager.class.getName()).log(Level.SEVERE, null, ex);
      }
  }
   ...
   */
  private EmojiManager() {ALL_EMOJIS = null;}
