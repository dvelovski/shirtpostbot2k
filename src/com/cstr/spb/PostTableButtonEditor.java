 ...
 *
 */
public class PostTableButtonEditor extends AbstractCellEditor
     ...
     */
    public PostTableButtonEditor(JTable table, Action action, int column) {
        this.table = table;
        this.action = action;
        ...
        setModelButtons(column);
        
        table.addMouseListener(this);
        renderButton.setText("View...");
        editButton.setText("View...");
    }
    public void setModelButtons(int col){
